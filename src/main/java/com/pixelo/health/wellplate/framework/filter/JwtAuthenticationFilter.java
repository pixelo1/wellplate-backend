...
import com.pixelo.health.wellplate.framework.spi.JwtExtractor;
import com.pixelo.health.wellplate.framework.auth.TokenExpiredException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean authenticationTokenValidation() {
