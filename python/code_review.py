...
for code_content in code_contents:
    prompt = f"""
    You are an experienced software server engineer. 
    provide a code review for the following code changes. 
    clearly express and explain the modifications to the existing code concerning code quality, potential bugs, and improvements. 
